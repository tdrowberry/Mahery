...
export const CHAPTER_BACKGROUNDS: Record<number, { url: string; tint?: 'dark' | 'warm' }> = {
  1: { url: asset('/art/backgrounds/prairie-river-sunset.jpg') },   // Snake: the open road
  2: { url: asset('/art/backgrounds/forest-stream.jpg') },          // Spider: the webbed forest
  3: { url: asset('/art/backgrounds/mountain-river-valley.jpg') },  // Crocodile: the river crossing
  4: { url: asset('/art/backgrounds/icy-tundra.jpg') },             // Vulture: bleak, at his weakest
  5: { url: asset('/art/backgrounds/forest-stream.jpg'), tint: 'dark' }, // Raven: the black canopy
  6: { url: asset('/art/backgrounds/mountain-river-valley.jpg'), tint: 'warm' }, // Final: the chief's fire
};
